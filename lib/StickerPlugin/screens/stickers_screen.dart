...
import 'package:flutter_merraland_online_new/StickerPlugin/Widgets/Drawer.dart';
import 'package:flutter_merraland_online_new/StickerPlugin/constants/constants.dart';
import 'package:flutter_merraland_online_new/StickerPlugin/models/sticker_data.dart';
import 'package:dio/dio.dart';
import 'package:flutter_merraland_online_new/StickerPlugin/widgets/sticker_pack_item.dart';
...
class _StickersScreenState extends State<StickersScreen> {
  ...
  didChangeDependencies() {
    ...
    stickerFetchType = "remoteStickers";
    setState(() {
      _isLoading = true;
    });
    _loadStickers();
